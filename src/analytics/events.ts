...
export const EVENTS = {
  ...
  CARE_COMPANION: {
    ...
    MEDICATION_TIMELINE: {
      ...
      GENERATE_TAP: "CARE_COMPANION:MedicationTimeline:generate-tap",
      GENERATE_SUCCESS: "CARE_COMPANION:MedicationTimeline:generate-success",
      GENERATE_ERROR: "CARE_COMPANION:MedicationTimeline:generate-error",
      DOWNLOAD_PDF: "CARE_COMPANION:MedicationTimeline:download-pdf",
      UPLOAD_TAP: "CARE_COMPANION:MedicationTimeline:upload-tap",
      UPLOAD_FILE_SELECTED: "CARE_COMPANION:MedicationTimeline:upload-file-selected",
      UPLOAD_SUCCESS: "CARE_COMPANION:MedicationTimeline:upload-success",
      UPLOAD_ERROR: "CARE_COMPANION:MedicationTimeline:upload-error",
      INSIGHTS_GENERATED: "CARE_COMPANION:MedicationTimeline:insights-generated",
    },
    CARE_HISTORY: {
