...
export const EVENTS = {
  ...
  PAYMENT: {
    ...
    TREATMENT_DETAILS_PROVIDER_SELECT: 'PAYMENT:TreatmentDetails:provider-select',
  ...
  CIRCLE: {
    ...
    INVITE_REJECTED_INVITE_NEW_TAPPED: 'CIRCLE:InviteRejected:invite-new-tapped',
    INVITE_REJECTED_SEE_CIRCLE_TAPPED: 'CIRCLE:InviteRejected:see-circle-tapped',
