...
describe("CircleInviteReminderCard — 4h variant (CIRCLE_INVITE_4H_OWNER)", () => {
  it("renders 'Still waiting on John?' as the title", () => {
    render(
      <CircleInviteReminderCard {...base} subType="CIRCLE_INVITE_4H_OWNER" />
    )
    expect(screen.getByText("Still waiting on John?")).toBeInTheDocument()
  })
  ...
  it("renders the action pills as Chips (ghost 'View details', secondary 'Resend invite')", () => {
    render(
      <CircleInviteReminderCard {...base} subType="CIRCLE_INVITE_4H_OWNER" />
    )
    expect(
...
describe("CircleInviteReminderCard — 24h variant (CIRCLE_INVITE_24H_OWNER)", () => {
  it("renders 'Invite someone else?' as the title", () => {
    render(
      <CircleInviteReminderCard {...base} subType="CIRCLE_INVITE_24H_OWNER" />
    )
