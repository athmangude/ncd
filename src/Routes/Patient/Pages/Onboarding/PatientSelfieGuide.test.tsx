...
import PatientSelfieGuide from "./PatientSelfieGuide"
...
function wrap(ui: ReactNode) {
  return createElement(
    MemoryRouter,
    { initialEntries: ["/patients/selfie-guide"] },
    ui
  )
}
...
describe("PatientSelfieGuide footer migration", () => {
  it("renders the Back CTA in the footer", () => {
    render(wrap(<PatientSelfieGuide />))
