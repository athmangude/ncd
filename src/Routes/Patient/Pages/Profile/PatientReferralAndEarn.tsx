    ...
    >
      <div className="flex flex-col gap-8 items-center text-center pt-6">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-neutral-900">Invite friends, get rewarded</h2>
          <p className="text-neutral-500 text-base leading-relaxed max-w-xs mx-auto">
            Share your unique code with friends. When they sign up and use your code, you both earn rewards!
          </p>
        </div>
        ...
        <div className="w-full max-w-sm bg-neutral-50 border border-dashed border-neutral-300 rounded-xl p-6 flex flex-col items-center gap-3 relative">
          <span className="text-sm text-neutral-500 uppercase tracking-wider font-medium">Your Referral Code</span>
        ...
        <p className="text-xs text-neutral-400 max-w-xs">
          Terms and conditions apply. Rewards are credited after the referred user completes their first transaction.
        </p>
      </div>
    </MobileWrapper>
  )
