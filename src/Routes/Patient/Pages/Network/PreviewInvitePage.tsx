...
export default function PreviewInvitePage() {
  ...
  if (inviteSent) {
    ...
    return (
      <PatientPageWrapper title="Invite sent!" showHelp={false}>
        <div className="flex flex-col h-full max-w-md mx-auto w-full">
          <div className="flex flex-col flex-1 items-center justify-center gap-6 px-4 pb-32">
                ...
                <div className="flex items-start gap-2 px-2.5 py-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-neutral-500">
                      Send {inviteeName} a quick message to say it&apos;s
                      coming.
                    </p>
                  </div>
  ...
  return (
    <PatientPageWrapper title="Preview invite" showHelp={false}>
      <div className="flex flex-col h-full max-w-md mx-auto w-full">
